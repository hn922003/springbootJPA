...
-- data.sql을 수정한 Entity에 맞게 수정한다.
insert into member2(id, name, email, nick, create_at) values (nextval('member_id_seq'), '홍길동', 'hong@tjoeun.com', '도적넘1', now());
insert into member2(id, name, email, nick, create_at, update_at) values (nextval('member_id_seq'), '임꺽정', 'lim@tjoeun.com', '도적넘2', now(), now());
insert into member2(id, name, email, nick, create_at, update_at) values (nextval('member_id_seq'), '장길산', 'jang@tjoeun.com', '도적넘3', now(), now());
insert into member2(id, name, email, nick, create_at, update_at) values (nextval('member_id_seq'), '일지매', 'il@tjoeun.com', '도적넘4', now(), now());
insert into member2(id, name, email, nick, create_at, update_at) values (nextval('member_id_seq'), '홍길동', 'gildong@tjoeun.com', '도적넘5', now(), now());
insert into member2(id, name, email, nick, create_at, update_at) values (nextval('member_id_seq'), '홍길동', 'hong2@tjoeun.com', '도적넘6', now(), now());
